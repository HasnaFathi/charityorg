...
//        Button addImage = findViewById(R.id.btn_add_project_image);
        ...
        r.child("category").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(AddProject.this, android.R.layout.simple_spinner_item, catList);
        ...
        btnAddProject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(name.getText().toString())) {
                    ...
                    Toast.makeText(AddProject.this, "Please enter a Project name", Toast.LENGTH_SHORT).show();

//                } else if(TextUtils.isEmpty(email.getText().toString())) {
                } else if(!validateEmail()) {

                    Toast.makeText(AddProject.this, "Please enter a valid contact email address", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(MainActivity.this, "Please enter a contact number", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AddProject.this, "Please enter a valid contact number", Toast.LENGTH_SHORT).show();
                    return;

                //} else if(TextUtils.isEmpty(deadline.getText().toString())) {
                } else if(!validateDeadline()) {

                    Toast.makeText(AddProject.this, "Please enter a valid deadline", Toast.LENGTH_SHORT).show();

                } else if(TextUtils.isEmpty(donationGoal.getText().toString())) {

                    Toast.makeText(AddProject.this, "Please enter a donation goal", Toast.LENGTH_SHORT).show();

                } else if(TextUtils.isEmpty(doantionMin.getText().toString())) {

                    Toast.makeText(AddProject.this, "Please enter a minimum donation amount", Toast.LENGTH_SHORT).show();

                } else if(TextUtils.isEmpty(Description.getText().toString())) {

                    Toast.makeText(AddProject.this, "Please enter a project description", Toast.LENGTH_SHORT).show();
        ...
        riversRef.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull @NotNull Exception e) {
                        ...
                        Toast.makeText(AddProject.this, "Failed to upload Image", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                })
